...
import OptionDataSummary from './OptionDataSummary'
...
export default () => {
    ...
    const { getOptionDatacontext, optionData } = useContext(Context);
    ...
    const filterByDate = (e) => {
        ...
        // console.log("filterByDa",filterByDa[0])
    ...
    const getAllOptionData = async () => {
        const respo = await getOptionData();
        if (respo) {
            getOptionDatacontext(respo)
            var columns = [
                {
                    name: "Date",
                ...
                {
                    name: "Expiry",
                    selector: (row) => row.Expiry.split(",")[0],
                    sortable: true,
                    width: "140px"
                }
            ]
    ...
    function JsonToCSV() {
        ...
        optionData && optionData.forEach(airport => {
    ...
    function downloadCSV(csvStr) {
        ...
        hiddenElement.download = 'OptionData.csv';
        hiddenElement.click();
    }
    ...
    return (
        <>
            ...
            {showSummay &&
                <OptionDataSummary backToForm={backToForm} />
            }
